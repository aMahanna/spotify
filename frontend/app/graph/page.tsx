  ...
  useEffect(() => {
    const loadGraphData = async () => {
      try {
        ...
        // First try to load from the backend graph endpoint
        if (source !== "local") {
          try {
            ...
            if (backendResponse.ok) {
              ...
              if (
                ...
                console.warn("Backend returned empty or invalid data, trying other methods")
              }
            } else {
              console.warn(`Backend returned status ${backendResponse.status}, trying other methods`)
            }
          } catch (backendError) {
            console.error("Error accessing backend:", backendError)
